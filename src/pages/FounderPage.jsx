...
const FounderPage = () => {
  return (
    <div className="pt-20 sm:pt-24 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mb-10">
      ...
      {/* Founder Card */}
      <div className="bg-white shadow-md rounded-xl p-5 sm:p-6 md:p-8">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-8">
          {/* Profile Image */}
          <div className="w-28 h-28 sm:w-32 sm:h-32 md:w-36 md:h-36 rounded-full overflow-hidden bg-gray-200 shrink-0">
            <img
        ...
        <div className="mt-4 flex justify-center md:justify-start gap-4">
          <a
            ...
            className="w-9 h-9 flex items-center justify-center rounded-full bg-gray-100 text-gray-600 hover:bg-blue-600 hover:text-white transition"
            aria-label="LinkedIn"
          >
            <FaLinkedin size={16} />
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-9 h-9 flex items-center justify-center rounded-full bg-gray-100 text-gray-600 hover:bg-pink-600 hover:text-white transition"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-9 h-9 flex items-center justify-center rounded-full bg-gray-100 text-gray-600 hover:bg-gray-800 hover:text-white transition"
            aria-label="GitHub"
          >
            <FaGithub size={16} />
          </a>
          ...
          <a
            ...
            className="w-9 h-9 flex items-center justify-center rounded-full bg-gray-100 text-gray-600 hover:bg-green-600 hover:text-white transition"
            aria-label="Email"
          >
            <FaEnvelope size={16} />
          </a>
